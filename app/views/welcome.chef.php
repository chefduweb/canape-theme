...
<div id="app">
	<div class="wrapper">
		<div class="head">
			...
			<h1>{{ __('Congratulations!', CUISINE_TEXTDOMAIN) }}</h1>
			<p>{{ __('The Cuisine framework is running.', CUISINE_TEXTDOMAIN) }}</p>
		</div>
		<div class="frame clearfix">
			<div id="get-started">
				<div class="container">
					<h2>{{ __('Get started:', CUISINE_TEXTDOMAIN) }}</h2>
					<p>{{ __('Check the documentation and build your next WordPress website/application.', CUISINE_TEXTDOMAIN) }}</p>
					<a href="http://framework.cuisine.com/docs/" target="_blank" title="{{ __('Cuisine framework documentation', CUISINE_TEXTDOMAIN) }}">{{ __('View documentation', CUISINE_TEXTDOMAIN) }}</a>
				</div>
			</div>
			<div id="links">
				<div class="container">
					<h3>{{ __('Links:', CUISINE_TEXTDOMAIN) }}</h3>
					<ul>
						<li><a href="http://framework.cuisine.com" target="_blank" title="Cuisine framework">Cuisine framework</a></li>
						<li><a href="https://github.com/cuisine" target="_blank" title="GitHub - Cuisine">GitHub</a></li>
						<li><a href="https://twitter.com/Cuisine" target="_blank" title="Twitter - Cuisine">Twitter</a></li>
					</ul>
				</div>
			</div>
		</div>
